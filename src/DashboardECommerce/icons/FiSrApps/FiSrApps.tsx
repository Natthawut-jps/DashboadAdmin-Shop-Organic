...
export const FiSrApps = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <g clipPath="url(#clip0_96_55148)">
        ...
        />
        <path
          d="M15 0H12.75C11.0931 0 9.75 1.34315 9.75 3V5.25C9.75 6.90686 11.0931 8.25001 12.75 8.25001H15C16.6568 8.25001 18 6.90686 18 5.25V3C18 1.34315 16.6568 0 15 0Z"
          fill="#858D9D"
        />
        <path
